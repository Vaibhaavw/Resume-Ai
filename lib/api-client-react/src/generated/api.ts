...
export const enhanceResume = async (
  id: number,
  enhanceResumeBody: EnhanceResumeBody,
  options?: RequestInit,
  ...
  return customFetch<EnhancedContent>(getEnhanceResumeUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(enhanceResumeBody),
  });
};
...
export const getCalculateAtsScoreMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type CalculateAtsScoreMutationResult = NonNullable<
  Awaited<ReturnType<typeof calculateAtsScore>>
>;
 ...
 * @summary Calculate ATS score for a resume
 */
export const useCalculateAtsScore = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getSectorKeywords = async (
  sector: string,
  options?: RequestInit,
): Promise<SectorKeywords> => {
...
export const getGetSectorKeywordsQueryKey = (sector: string) => {
  return [`/api/ats/keywords/${sector}`] as const;
};

export const getGetSectorKeywordsQueryOptions = <
  TData = Awaited<ReturnType<typeof getSectorKeywords>>,
  TError = ErrorType<unknown>,
>(
  sector: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getSectorKeywords>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetSectorKeywordsQueryKey(sector);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getSectorKeywords>>
  > = ({ signal }) => getSectorKeywords(sector, { signal, ...requestOptions });
...
export type GetSectorKeywordsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSectorKeywords>>
>;
...
export function useGetSectorKeywords<
  TData = Awaited<ReturnType<typeof getSectorKeywords>>,
  TError = ErrorType<unknown>,
>(
  sector: string,
...
export const triggerSignupWebhook = async (
  webhookSignupBody: WebhookSignupBody,
  options?: RequestInit,
): Promise<MessageResponse> => {
  return customFetch<MessageResponse>(getTriggerSignupWebhookUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(webhookSignupBody),
  });
};

export const getTriggerSignupWebhookMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type TriggerSignupWebhookMutationResult = NonNullable<
  Awaited<ReturnType<typeof triggerSignupWebhook>>
>;
 ...
 * @summary Trigger n8n welcome email webhook (internal)
 */
export const useTriggerSignupWebhook = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
