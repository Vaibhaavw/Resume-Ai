...
const features = [
  ...
  },
  {
    ...
    desc: "Choose from modern, minimalist, executive, and creative templates designed by professional resume writers.",
  },
  {
...
const tiers = [
  {
    ...
    features: ["3 basic templates", "ATS score analysis", "PDF export", "Basic sector keywords"],
  ...
  },
  {
    ...
    features: ["10 premium templates", "75-90% ATS guarantee", "AI bullet point suggestions", "PDF & Word export", "Priority support"],
    cta: "Start Pro Trial",
    popular: true,
  },
  {
    ...
    features: ["All templates", "95%+ ATS optimization", "Cover letter generator", "AI content rewrites", "Early feature access"],
    cta: "Go Premium",
    popular: false,
  },
];
